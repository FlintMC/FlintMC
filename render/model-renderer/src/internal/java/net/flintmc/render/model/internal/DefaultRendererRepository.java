...
public class DefaultRendererRepository implements RendererRepository {
  ...
  private final Map<Class<? extends RenderContextAware<?>>, Renderer<?, ?>> classDefinedRenderers =
      new HashMap<>();
