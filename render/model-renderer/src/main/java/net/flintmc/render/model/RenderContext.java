...
public interface RenderContext<
    ...
    T_RenderContext extends
        RenderContext<T_RenderContextAware, T_RenderContext, T_Renderable, T_RenderMeta, T_RenderTarget>,
    T_Renderable extends Renderable<T_RenderContextAware, T_RenderContext, T_Renderable, T_RenderTarget>,
    T_RenderMeta,
    T_RenderTarget> {
  ...
  T_Renderable getRenderableByMeta(T_RenderTarget target);
