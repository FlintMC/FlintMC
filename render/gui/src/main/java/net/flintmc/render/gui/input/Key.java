...
public enum Key {
  ...
  MOUSE_LEFT("key.false.left", 0, -100, true),
  MOUSE_RIGHT("key.false.right", 1, -99, true),
  MOUSE_MIDDLE("key.false.middle", 2, -98, true),
  MOUSE_4("key.false.4", 3, -97, true),
  MOUSE_5("key.false.5", 4, -96, true),
  MOUSE_6("key.false.6", 5, -95, true),
  MOUSE_7("key.false.7", 6, -94, true),
  MOUSE_8("key.false.8", 7, -93, true),
