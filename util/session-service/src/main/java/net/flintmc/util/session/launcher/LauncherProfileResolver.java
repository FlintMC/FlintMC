...
public interface LauncherProfileResolver {
   ...
   * Tasks#POST_MINECRAFT_INITIALIZE} task has been called, otherwise it may throw
   ...
   * {@link Tasks#POST_MINECRAFT_INITIALIZE} task has been called, otherwise it may throw
   * unspecified exceptions.
   *
