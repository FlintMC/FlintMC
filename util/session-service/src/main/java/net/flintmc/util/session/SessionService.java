 ...
 * <p>
 * It may not be used before the {@link Tasks#POST_MINECRAFT_INITIALIZE} task has been
 * called.
 */
public interface SessionService {
   ...
   * SessionAccountLogInEvent} and it doesn't have any effects on the session of the
