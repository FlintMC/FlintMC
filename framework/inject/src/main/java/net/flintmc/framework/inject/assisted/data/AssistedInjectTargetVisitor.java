 ...
 * bindings created by using {@link AssistedFactoryModuleBuilder} will be visited through this interface.</p>
 *
 * @param <T> The type of the binding.
 * @param <V> Any type to be returned by the visit method. Use {@link Void} with return {@code null} if no
...
public interface AssistedInjectTargetVisitor<T, V> extends BindingTargetVisitor<T, V> {
   ...
   * @return Any type to be returned by the visit method. Use {@link Void} with return {@code null} if no
   * return type is needed.
   */
