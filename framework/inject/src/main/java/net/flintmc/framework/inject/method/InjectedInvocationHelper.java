...
public interface InjectedInvocationHelper {
  ...
  /**
   * Invokes the given method on an instance of the declaring class fetched using Guice with
   * parameter bindings made available via the given map.
   *
   * @param method The method to invoke
  ...
  /**
   * Invokes the given method on the given instance with parameter bindings made available via the
   * given map.
   *
   * @param method The method to invoke
   * @param instance The instance to invoke the method on
