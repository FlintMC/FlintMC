...
/**
 * Represents a location a package can be access with. Currently package sources
 * are considered to be an implementation detail.
 */
public interface PackageSource extends AutoCloseable {
   ...
   * @return The created source which can be used to access resources of the
   * package
   ...
   * @return An enumeration of all resources matching the given name accessible
   * with this source
   ...
   * @throws IOException        If an I/O error occurred while locating the
   *                            resources
   * @throws URISyntaxException If an URISyntaxException occurred while locating
   *                            the resource.
   */
