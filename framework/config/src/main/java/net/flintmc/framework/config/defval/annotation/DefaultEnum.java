...
public @interface DefaultEnum {
  ...
  /**
   * The default value which should be used if it is not set in a {@link ConfigStorage}. Since this
   * sets an enum, this retrieves the index of the enum constant that should be used as the default
   * value.
   *
