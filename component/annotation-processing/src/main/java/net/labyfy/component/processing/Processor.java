...
public interface Processor {
  /**
   * Called by the {@link ProcessorState} of the current {@link LabyfyAnnotationProcessor} for every annotation found.
   *
  ...
  /**
   * Called by the {@link ProcessorState} of the current {@link LabyfyAnnotationProcessor} in the final round to
