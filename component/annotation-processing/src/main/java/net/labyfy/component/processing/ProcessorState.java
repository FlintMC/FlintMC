...
/**
 * <p>
 * Representation of the internal state of the {@link LabyfyAnnotationProcessor} to provide a
...
public class ProcessorState {
  ...
  /**
   * Called by the {@link LabyfyAnnotationProcessor} to set the {@link ProcessingEnvironment}. May only be
   * called once.
   *
  ...
  /**
   * Called by the {@link LabyfyAnnotationProcessor} to begin a new round of processing and update the used
  ...
  /**
   * Called by the {@link LabyfyAnnotationProcessor} to signal the child processors to accept the given
   * annotation.
   *
   * @param annotation The annotation found by the {@link LabyfyAnnotationProcessor}
   */
  ...
  /**
   * Called by the {@link LabyfyAnnotationProcessor} to signal that the last round is running and everything
