...
public class MinecraftJuklearOpenGLDevice {
  ...
  public void draw(
    ...
    context.drawForEach(commandBuffer, (drawCommand) -> {
      ...
      /*
      glScissor(
          ((int) (drawCommand.getClipRect().getX())),
          ((int) ((height - drawCommand.getClipRect().getY() - drawCommand.getClipRect().getHeight()) )),
          ((int) (drawCommand.getClipRect().getWidth())),
          ((int) (drawCommand.getClipRect().getHeight())));
*/
