...
public class TaskService implements ServiceHandler<Task> {
   ...
   */
  @Override
  public void discover(DetectableAnnotationProvider.AnnotationMeta<Task> identifierMeta) throws ServiceNotFoundException {
    ...
    executor.register(annotation, identifierMeta.<DetectableAnnotationProvider.AnnotationMeta.MethodIdentifier>getIdentifier().getLocation());
  }
