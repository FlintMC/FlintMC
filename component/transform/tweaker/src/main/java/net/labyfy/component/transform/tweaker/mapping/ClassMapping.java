...
public class ClassMapping {
  ...
  public String translateMethodDescription(String obfDesc) {
    ...
    while (currentIndex != tempObfDesc.length()) {
      if (tempObfDesc.charAt(currentIndex) != 'L') {
        ...
        ClassMapping descClassMapping = this.labyClassMappingProvider.get(obfClassName);
        unObfDesc
            .append("L")
            .append(
  ...
  public Collection<FieldMapping> getFields() {
    return this.obfuscatedFieldMappings.values();
  }
  ...
  public static ClassMapping create(
      ...
      String obfuscatedName,
      String unObfuscatedName) {
    return new ClassMapping(labyClassMappingProvider, obfuscatedName, unObfuscatedName);
  }
}
