...
public class InternalMethodVisitorContext extends MethodVisitor implements MethodVisitorContext {
  ...
  public InternalMethodVisitorContext(MethodVisit methodVisit) {
    super(Opcodes.ASM5);
