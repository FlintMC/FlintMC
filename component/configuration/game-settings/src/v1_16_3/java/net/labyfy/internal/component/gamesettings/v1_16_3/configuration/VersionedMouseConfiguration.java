...
import net.labyfy.component.gamesettings.configuration.MouseConfiguration;
import net.labyfy.component.inject.implement.Implement;
import net.minecraft.client.Minecraft;

/**
 * 1.16.3 implementation of the {@link MouseConfiguration}.
 */
@Singleton
@Implement(value = MouseConfiguration.class, version = "1.16.3")
