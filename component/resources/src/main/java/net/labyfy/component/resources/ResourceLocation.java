...
public interface ResourceLocation {
  ...
  /**
   * Retrieves a the underlying vanilla object. This should only be used in
   * versioned code since this function is unsafe and may cause unexpected {@link ClassCastException}s.
   *
   ...
   * @throws java.io.FileNotFoundException If the resource location can't be found in any selected pack
  ...
  interface Factory {
     ...
     *
     * @param fullPath A path string in the format {@code "namespace:location"} or
     *                 {@code "location"} for the minecraft namespace
