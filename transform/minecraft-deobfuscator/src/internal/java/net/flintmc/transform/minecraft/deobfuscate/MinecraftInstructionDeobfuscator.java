...
package net.flintmc.transform.minecraft.deobfuscate;
...
import net.flintmc.transform.minecraft.deobfuscate.remap.MinecraftClassRemapper;
...
public class MinecraftInstructionDeobfuscator implements LateInjectedTransformer,
    CacheIdRetriever {
  ...
  @Inject
  private MinecraftInstructionDeobfuscator(
