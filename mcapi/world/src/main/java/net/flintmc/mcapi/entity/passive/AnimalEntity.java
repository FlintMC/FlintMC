...
public interface AnimalEntity extends AgeableEntity {
   ...
   * @return {@code true} if the given item stack is the breeding item for this animal entity, otherwise {@code false}.
   */
   ...
   * @return {@code true} if this animal entity can mate with the given animal, otherwise {@code false}.
   */
  ...
  interface Factory {
     ...
     */
    AnimalEntity create(@Assisted("entity") Object entity, @Assisted("entityType") EntityType entityType);
