package net.flintmc.mcapi.server.v1_16_3.status;
...
import net.flintmc.mcapi.server.internal.status.DefaultServerFavicon;
import net.flintmc.mcapi.server.internal.status.DefaultServerPlayers;
import net.flintmc.mcapi.server.internal.status.DefaultServerVersion;
...
@Implement(value = PendingStatusRequest.class, version = "1.16.3")
