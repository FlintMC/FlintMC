...
public interface ScoreComponentBuilder extends ComponentBuilder<ScoreComponentBuilder> {
  ...
  /**
   * Sets the name of the current component. The client will display the value out of the scoreboard where this key is
   * the line that is displayed next to the value.
   *
   ...
   *
   * @return The name of the current component in the scoreboard or {@code null} if no name has been provided
   * @see #name(String)
   */
  String name();

  /**
   * Sets the objective of the current component. The client will use this to get the objective containing the value to
   * display.
   *
   ...
   *
   * @return The objective of the current component in the scoreboard or {@code null} if no objective has been provided
