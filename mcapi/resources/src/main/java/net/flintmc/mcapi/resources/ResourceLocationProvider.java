...
public interface ResourceLocationProvider {
  /**
   * Creates a resource location with the given path. Equivalent to {@link ResourceLocation.Factory#create(String)}.
   *
   ...
   * @return A collection of all currently loaded resource locations matching
   * the given predication within the namespace
   */
