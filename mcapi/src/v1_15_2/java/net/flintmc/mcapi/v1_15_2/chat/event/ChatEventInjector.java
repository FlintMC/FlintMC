...
public class ChatEventInjector {
  ...
  public void handleChatMessageAdd(@Named("args") Object[] args) {
    ...
    this.lastMessage = new ReceivedChatMessage(component, flintComponent, location);
  }
  ...
  public ITextComponent handleChatReceive(
    ...
    ChatReceiveEvent event = this.receiveFactory.create(location, flintComponent, NO_SENDER);
    ...
    this.lastMessage = new ReceivedChatMessage(result, event.getMessage(), location);
    return result;
  }
