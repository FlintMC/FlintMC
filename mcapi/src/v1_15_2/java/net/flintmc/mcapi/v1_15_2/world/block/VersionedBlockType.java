...
@Implement(value = BlockType.class, version = "1.15.2")
public class VersionedBlockType implements BlockType {
  ...
  public VersionedBlockType(
    ...
    this.displayName = componentMapper.fromMinecraft(this.handle.getNameTextComponent());
  ...
  public boolean hasTileEntity() {
    return this.handle.hasTileEntity();
  }
