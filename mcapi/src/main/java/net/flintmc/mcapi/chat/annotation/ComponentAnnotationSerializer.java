...
public interface ComponentAnnotationSerializer {
  ...
  /**
   * Maps the given components into a {@link ChatComponent}. The components will be deserialized like in {@link
   * #deserialize(Component)} and chained together.
   *
   ...
   * #deserialize(Component)} and chained together.
   * <p>
   * If {@code components.length} is 0, {@code def} will be returned.
   *
   * @param components The non-null component annotation to be deserialized
   ...
   * #deserialize(Component)} and chained together.
   * <p>
   * If {@code components.length} is 0, {@code def} will be parsed into a {@link ChatComponent} with {@link
   * ComponentSerializer.Factory#legacy()} and returned.
   *
   * @param components The non-null component annotation to be deserialized
