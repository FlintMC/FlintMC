...
public interface TranslationComponent extends ChatComponent {
  ...
  /**
   * Retrieves the translation value for the {@link #translationKey()} of this component or the key if there is no
   ...
   * <p>
   * Minecraft will replace %s in the translation with the arguments of the {@link TranslationComponent}.
   *
  ...
  /**
   * Appends a new argument to the arguments of this component for translation of the current component.
   * <p>
   * Minecraft will replace %s in the translation with the arguments of the {@link TranslationComponent}.
   *
  ...
  /**
   * Retrieves all arguments of this component that are used by Minecraft for the translation of the {@link
   * TranslationComponent}.
   *
   * @return A non-null array of all arguments. Modifications to this array will have no effect on this component,
   * however modifications to the components in this array will have an effect on this component
   */
