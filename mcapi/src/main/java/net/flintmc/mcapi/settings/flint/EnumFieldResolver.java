...
public interface EnumFieldResolver {
  ...
  /**
   * Retrieves all fields that belong to enum constants in the given enum class with the key being the {@link
   * Enum#name() name of the constant} and value the field that belongs to the enum constant.
   *
