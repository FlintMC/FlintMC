...
import net.flintmc.mcapi.v1_16_4.entity.VersionedAgeableEntity;
import net.flintmc.mcapi.world.World;
import net.minecraft.nbt.CompoundNBT;
import net.minecraft.util.ActionResultType;

@Implement(value = AnimalEntity.class, version = "1.16.4")
public class VersionedAnimalEntity extends VersionedAgeableEntity implements AnimalEntity {
  ...
  public boolean processInteract(PlayerEntity entity, Hand hand) {
    ActionResultType actionResultType = this.animalEntity.processInitialInteract(
        (net.minecraft.entity.player.PlayerEntity)
