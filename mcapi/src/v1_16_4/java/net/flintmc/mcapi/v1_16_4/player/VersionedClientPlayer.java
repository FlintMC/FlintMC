...
@Singleton
@Implement(value = ClientPlayer.class, version = "1.16.4")
public class VersionedClientPlayer extends VersionedPlayerEntity implements ClientPlayer {
  ...
  public String getBiome() {
    ...
    if (world != null) {
      Optional<MutableRegistry<Biome>> biomes = world.func_241828_r()
      ...
      String biomePath = biomes.get().getKey(world.getBiome(blockPos)).getPath();
  ...
  public void knockBack(
    ...
    Minecraft.getInstance().player.applyKnockback(strength, xRatio, zRatio);
  }
  ...
  public List<net.flintmc.mcapi.entity.Entity> getPassengers() {
    ...
    for (Entity passenger : this.wrapped().getPassengers()) {
      passengers.add(
