...
package net.flintmc.mcapi.v1_16_5.tileentity;
...
@Implement(value = TileEntity.class, version = "1.16.5")
public class VersionedTileEntity implements TileEntity {
  ...
  public double getDistanceSq(double x, double y, double z) {
    ...
    double ySq = this.getPosition().getY() + 0.5D - y;
    double zSq = this.getPosition().getZ() + 0.5D - z;
