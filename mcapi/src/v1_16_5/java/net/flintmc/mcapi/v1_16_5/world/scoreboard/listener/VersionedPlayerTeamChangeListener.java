...
package net.flintmc.mcapi.v1_16_5.world.scoreboard.listener;
...
@Implement(value = PlayerTeamChangeListener.class, version = "1.16.5")
public class VersionedPlayerTeamChangeListener implements PlayerTeamChangeListener {
  ...
  public void changeColor(PlayerTeam playerTeam, String colorName) {
    this.getPlayerTeam(playerTeam).ifPresent(team -> team.setColor(TextFormatting.valueOf(colorName.toUpperCase())));
  }
  ...
  public void changeColor(PlayerTeam playerTeam, ChatColor chatColor) {
    this.changeColor(playerTeam, chatColor.getName());
  }
