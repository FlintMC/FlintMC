...
public class VersionedEntity implements Entity {
  ...
  public boolean handleWaterMovement() {
    AccessibleEntity accessibleEntity = (AccessibleEntity) this.wrapped();
    return accessibleEntity.func_233566_aG_();
  }
  ...
  public void spawnRunningParticles() {
    AccessibleEntity accessibleEntity = (AccessibleEntity) this.wrapped();
    accessibleEntity.handleRunningEffect();
  }
  ...
  public void setInLava() {
    AccessibleEntity accessibleEntity = (AccessibleEntity) this.wrapped();
    accessibleEntity.setOnFireFromLava();
  }
  ...
  public void move(MoverType moverType, Vector3D vector3D) {
    this.wrapped()
        .move(
            ...
            new Vector3d(vector3D.getX(), vector3D.getY(), vector3D.getZ()));
  }
