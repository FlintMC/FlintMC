...
public class VersionedGLFWInputConverter {
   ...
   */
  public static Key glfwKeyToLabyfyKey(int key) {
    switch(key) {
   ...
   */
  public static Set<ModifierKey> glfwModifierToLabyfyModifier(int modifiers) {
   ...
   */
  public static MouseButton glfwMouseButtonToLabyfyMouseButton(int button) {
    switch(button) {
   ...
   */
  public static InputState glfwActionToLabyfyInputState(int state) {
    switch(state) {
